...
dist:
	...
	$(TAR) czf $(PACKAGE)-$(VERSION).tar.gz \
		...
		$(PACKAGE)-$(VERSION)/plugin/umb/src/veritawall/scripts/Veritawall/umb/umbctl-gateway \
		$(PACKAGE)-$(VERSION)/plugin/umb/src/veritawall/service/conf/actions.d/actions_umb.conf \
